...
export const rocsFeather = [
  ...
  createFilteredLockObstacle('fourthLock', [
    'rocsFeatherGate1',
    'rocsFeatherGate3',
    'rocsFeatherKey',
    'thirdLockGate',
...
export const shadowTemple2 = [
  ...
  createSingleRoomPuzzle('ship', 'pink', [
    'invisibleWallKey',
    'invisibleWallGate',
    'statueFallGate',
    'statueFallKey',
  ...
  createSingleLock('ironBootsWind', 'green', [
    'bombableFloorGate',
    'bombableFloorKey',
    'firstLockGate',
  ]),
  ...
  createFilteredLockObstacle('thirdLock', [
    'silverRupee3Key',
    'silverRupee3Gate',
    'secondLockGate',
  ]),
...
export const waterTemple = [
  ...
  createLockObstacle('thirdLock', rootValue =>
    rootValue.getFilteredChildren(['longshotKey', 'firstLockKey'])
  ),
  ...
  createSingleLock('level2Water', 'orange', [
    'fifthLockGate',
    'longshotGate3',
    'thirdLockKey',
    'fourthLockKey',
  ]),
  createLockObstacle('sixthLock', rootValue =>
    rootValue.getFilteredChildren(['level2WaterGate', 'level2WaterKey'])
  ),
  createSingleLock('level1Water', 'orange', [
    'longshotGate2',
    'sixthLockGate',
    'fifthLockKey',
    'sixthLockKey',
...
export const waterTemple2 = [
  ...
  createKeyItem('longshot', 4, [
    'pullBlock1Key',
    'pullBlockGate',
    'secondLockGate',
    'level3WaterSecondGate',
  ]),
  createSingleLock('level2WaterSecond', 'orange', [
    'level3WaterSecondKey',
    'longshotGate3',
    'longshotGate4',
  ]),
  createSingleLock('level1WaterSecond', 'orange', [
    'level2WaterSecondKey',
    'level2WaterSecondGate',
  ]),
  ...
  createSingleLock('level2WaterFirst', 'orange', [
    'bombableRutoWallGate',
    'killDropEnemiesGate',
    'killDropEnemiesKey',
    'fifthLockGate',
    'level3WaterFirstKey',
  ...
  createSingleLock('level1WaterFirst', 'orange', [
    'fireArrowGate',
    'blockIntoWaterGate',
    'blockIntoWaterKey',
    'sixthLockGate',
  ]),
  createExternalLock('hookshotEntrance', [
    'level1WaterFirstGate',
    'level1WaterFirstKey',
    'longshotGate2',
    'longshotGate1',
    'pullBlock2Key',
...
export const gnarledRoot2 = [
  ...
  createSingleLock('minecartSwitch', 'cyan', [
    'bombWallGate',
    'bombWallKey',
    'simpleMazeKey',
    'simpleMazeGate',
  ]),
  createFilteredLockObstacle('secondLock', [
    'emberSeedsGate1',
    'minecartSwitchGate',
    'minecartSwitchKey',
  ]),
...
export const snakeRemains = [
  ...
  createKeyItem('powerBracelet', 2, [
    ['bombRaceGate', 'bombRaceKey'],
    ['pushblockPuzzleGate', 'pushblockPuzzleKey'],
  ]),
...
export const poisonMoth = [
  ...
  createKeyItem('rocsFeather', 2, [
    ['trampolinePuzzleKey', 'trampolinePuzzleGate'],
    'firstLockGate',
  ]),
  ...
  createPuzzleKey('potPush', [
    ['pushblockPuzzle2Gate', 'pushblockPuzzle2Key'],
    ['rollingPushBlockGate'],
    'rocsFeatherGate2',
  ]),
  createCombatPuzzleKey('enemies1', ['rocsFeatherGate1', 'potPushGate', 'potPushKey']),
]

export const dancingDragon = [
  createFilteredLockObstacle('firstLock', ['bossGate']),
...
export const dancingDragon2 = [
  ...
  createKeyItem('slingshot', 3, [
    'firstLockKey',
    ['running1Key', 'running1Gate'],
    ['minecartSwitch1Key', 'minecartSwitch1Gate'],
  ]),
  ...
  createMultiKey('doubleJump', 'green', 2, [
    'slingshotGate1',
    'secondLockKey',
    'minibossGate',
    'minibossKey',
...
export const unicornsCave = [
  ...
  createKeyItem('magneticGloves', 4, [
    'firstLockKey',
    'fourthLockGate',
    'secondLockKey',
    'thirdLockKey',
...
export const unicornsCave2 = [
  ...
  createKeyItem('magneticGloves', 3, [
    ['firstLockKey', 'fourthLockGate'],
    'secondLockKey',
    'thirdLockKey',
  ]),
  createFilteredLockObstacle('fifthLock', ['magneticGlovesKey']),
...
export const explorersCrypt = [
  ...
  createPuzzleKey('curse1', [
    'statuePuzzleKey',
    'statuePuzzleGate',
    'magneticBall1Key',
    'trampolinePuzzleGate',
    'trampolinePuzzleKey',
    'magneticBallGate',
  ]),
...
export const swordAndShield = [
  ...
  createFilteredLockObstacle('sixthLock', [
    'fifthLockGate',
    'hyperSlingshotGate',
    'hyperSlingshotKey',
    'nLockGate',
...
export const faceShrine = [
  createFilteredLockObstacle('firstLock', ['bossKey']),
  createFilteredLockObstacle('secondLock', ['firstLockGate']),
  createKeyItem('powerBracelet', 4, [
    'bossGate',
    'firstLockKey',
    'secondLockGate',
    'secondLockKey',
...
export const palaceOfDarkness = [
  ...
  createFilteredLockObstacle('fifthLock', [
    'thirdLockKey',
    'fourthLockKey',
    'fourthLockGate',
    'thirdLockGate',
...
export const greatBayTemple = [
  ...
  createSingleLock('redWaterFlow', 'orange', [
    'greenWaterFlowGate',
    'greenValve2Key',
    'greenValve3Key',
    'greenValve1Gate',
...
export const explorersCave = [
  ...
  createSingleLock('firstCurse', 'orange', [
    'thirdLockKey',
    'fourthLockGate',
    'fourthLockKey',
    'rocsCapeGate',
...
export const stoneTowerTemple = [
  createFilteredLockObstacle('firstLock', ['bossGate']),
  createFilteredLockObstacle('secondLock', ['bossKey']),
  createSingleLock('hookshotChestSpawn', 'orange', ['firstLockGate']),
  createSingleLock('flipDungeon', 'silver', [
    'firstLockKey',
    'secondLockKey',
    'secondLockGate',
    'hookshotChestSpawnKey',
    'hookshotChestSpawnGate',
  ]),
...
export const wingDungeon = [
  ...
  createExternalLock('pushBlockPuzzle', [
    'colorMovementGate',
    'colorMovementKey',
    'secondLockGate',
    'firstLockGate',
  ...
  createKeyItem('rocsFeather', 3, [
    'thirdLockGate',
    'secondLockKey',
    ['jumpPuzzleGate', 'jumpPuzzleKey'],
  ]),
  createMiniboss('miniboss', [
    'rocsFeatherGate1',
    'rocsFeatherGate2',
    'rocsFeatherGate3',
    'rocsFeatherKey',
...
export const moonlitGrotto = [
  ...
  createMiniboss('miniboss', [
    'seedShooterPuzzle2Gate',
    'seedShooterPuzzle2Key',
    'pushBlockGate',
    'pushBlockKey',
  ]),
...
export const skullDungeon = [
  ...
  createPuzzleKey('switchshotPuzzle3', [
    'colorSwitchGate',
    'colorSwitchKey',
    'jumpingSwitchshotGate',
    'jumpingSwitchshotKey',
  ]),
...
export const crownDungeon = [
  ...
  createKeyItem('somariaCane', 4, [
    'thirdLockKey',
    'secondLockKey',
    'seedShooterPuzzleKey',
    'thirdLockGate',
  ]),
...
export const mermaidsCave2 = [
  ...
  createKeyItem('mermaidSuit', 2, [
    ['currentsPuzzleKey', 'currentsPuzzleGate'],
    ['switchShotPuzzleGate'],
  ]),
  ...
  createExternalLock('seedShooter', [
    'bombableWallGate',
    'snakeScentGate',
    'snakeScentKey',
    'timeWallLock2Gate',
  ...
  // Past
  createSingleLock('timeTravelWall2', 'orange', [
    'secondLockGate',
    'mermaidSuitGate2',
    'timeWallLock2Key',
  ]),
...
export const jabujabuBelly = [
  createFilteredLockObstacle('firstLock', ['bossKey']),
  createFilteredLockObstacle('secondLock', ['firstLockGate']),
  createFilteredLockObstacle('thirdLock', ['secondLockGate']),
  createPuzzleKey('topSwitchshot', ['firstLockKey']),
  createSingleLock('raiseWaterSwitch2', 'orange', [
    'secondLockKey',
    'bossGate',
    'topSwitchshotGate',
    'topSwitchshotKey',
  ...
  createFilteredLockObstacle('fourthLock', [
    'thirdLockGate',
    'raiseWaterSwitch2Key',
    'raiseWaterSwitch2Gate',
  ]),
  ...
  createSingleLock('raiseWaterSwitch1', 'cyan', [
    'enemies1Gate',
    'enemies1Key',
    'minibossGate',
    'minibossKey',
...
export const jabujabuOracle = [
  ...
  createMultiLock('level1WaterFirst', 'orange', 4, [
    'switchShotGate3',
    'sixthLockKey',
    'sixthLockGate',
    'level2WaterGate2',
...
export const ancientTomb = [
  ...
  createMiniboss('miniboss', [
    'switchshotPuzzle3Gate',
    'sarcophogusGate',
    'firstLockGate',
    'jumpPuzzle1Gate',
    'powerGlovePuzzleKey',
    'powerGlovePuzzleGate',
  ]),
...
export const windTemple = [
  ...
  createSingleLock('firstFloor', 'orange', [
    'secondLockKey',
    'secondLockGate',
    'secondFloorGate',
    'makarGate2',
...
export const forestTempleTwilight = [
  ...
  createMultiKey('secondMonkey', 'orange', 2, [
    'boomerangKey',
    'thirdMonkey4Key',
    'boomerangPuzzleKey',
  ]),
  ...
  createMultiKey('firstMonkey', 'orange', 2, [
    'secondLockKey',
    'secondLockGate',
    'thirdLockKey',
    'thirdLockGate',
...
export const sandShip = [
  ...
  createSingleLock('timeShift1', 'grey', [
    'timeShift2Key',
    'timeShift2Gate',
    'cLockKey',
    'cLockGate2',
...
export const skullWoods = [
  createFilteredLockObstacle('firstLock', ['bossGate', 'bossKey']),
  createFilteredLockObstacle('secondLock', ['firstLockGate', 'firstLockKey']),
  createFilteredLockObstacle('thirdLock', ['secondLockGate', 'secondLockKey']),
]

export const towerOfHera = [
  createFilteredLockObstacle('firstLock', ['bossGate', 'bossKey']),
  createFilteredLockObstacle('secondLock', ['firstLockGate', 'firstLockKey']),
]

export const dragonRoostCavern = [
...
export const spiritTemple = [
  ...
  createSingleLock('fourMirrors', 'silver', [
    'lullabyHandKey',
    'lullabyHandGate',
    'secondLockGate',
  ]),
...
export const forestTemple = [
  ...
  createCombatPuzzleKey('fallingPuzzle', [
    'killPoeSister2Gate',
    'killPoeSister2Key',
    'poeSisters3Key',
  ]),
  ...
  createKeyItem('bow', 3, [
    ['bossKey', 'enemies5Key', 'enemies5Gate'],
    ['pictureShot1Gate', 'pictureShot1Key'],
    ['pictureShot2Gate', 'pictureShot2Key'],
  ]),
...
export const jabujabuOcarina = [
  ...
  createSingleLock('slingshot', 'green', [
    'throwRutoKey',
    'throwRutoGate',
    'boomerangGate',
    'greenTentacleGate',
