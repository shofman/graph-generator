...
export const evaluateDungeon = () => {
  ...
  if (verifiedDungeons) {
    ...
    const sortBySumOfKeys = (a,b) => {
      const aKey = a.keys
      const aDistanceAvg = (aKey.normalKey.avgDistance + aKey.specialKey.avgDistance + aKey.multiKey.avgDistance + aKey.multiLock.avgDistance) / a.numberOfNodes
      const aLockedDistance = (aKey.normalKey.lockedDistance + aKey.specialKey.lockedDistance + aKey.multiLock.lockedDistance + aKey.multiKey.lockedDistance) / a.numberOfNodes

      const bKey = b.keys
      const bDistanceAvg = (bKey.normalKey.avgDistance + bKey.specialKey.avgDistance + bKey.multiKey.avgDistance + bKey.multiLock.avgDistance) / b.numberOfNodes
      const bLockedDistance = (bKey.normalKey.lockedDistance + bKey.specialKey.lockedDistance + bKey.multiLock.lockedDistance + bKey.multiKey.lockedDistance) / b.numberOfNodes
